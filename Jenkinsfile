pipeline {
  ...
  environment {
    ...
    TESTING_PIPELINE_EXECUTION_ROLE = 'arn:aws:iam::677501797858:role/aws-sam-cli-managed-dev-pipe-PipelineExecutionRole-WLM6U6LMCR8G'
    TESTING_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::677501797858:role/aws-sam-cli-managed-dev-p-CloudFormationExecutionR-88OPYNBVTXX'
    TESTING_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-dev-pipeline-artifactsbucket-yhk5gt4s2ys8'
    ...
    PROD_PIPELINE_EXECUTION_ROLE = 'arn:aws:iam::677501797858:role/aws-sam-cli-managed-prod-pip-PipelineExecutionRole-7BZBGZ9JCI42'
    PROD_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::677501797858:role/aws-sam-cli-managed-prod-CloudFormationExecutionR-Q5WU1AA48VY2'
    PROD_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-prod-pipeline-artifactsbucket-pj62fj98whj1'
    // If there are functions with "Image" PackageType in your template,
